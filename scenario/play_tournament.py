...
def tournoi(generaux: list, list_scenario: dict, nb_combat=100, not_alternate=False, map_size=30):
    tournament = Tournament(generaux, list_scenario)
    print(list_scenario)
        ...
        for idx_g1 in range(len(generaux)):
            for idx_g2 in range(idx_g1, len(generaux)):
                ...
                for combat_num in range(nb_combat):
                    ...
                    partie = initialiser([g1_name, g2_name], list_scenario[sc], swap_positions=swap, map_size=map_size)
