...
class VuePygame:
    ...
    def _dessiner_hud(self, jeu, current_w):
        ...
        nb_unites_1 = len([u for u in jeu.unites if u.alive and u.equipe==0])
        nb_unites_2 = len([u for u in jeu.unites if u.alive and u.equipe==1])
        
        self.screen.blit(self.font_hud.render(f"|| {status}", True, status_color), (20, 14))
        self.screen.blit(self.font_hud.render(f"| Vue: Pygame  |  Tour: {jeu._tour}  |  Unites 1: {nb_unites_1}  |  Unites 2: {nb_unites_2}", 
